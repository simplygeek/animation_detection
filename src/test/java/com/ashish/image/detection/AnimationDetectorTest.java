...
public class AnimationDetectorTest {
    ...
    public Object[][] getImageInput() {
        return new Object[][]{{"gif_as_png.png", CLASSPATH, MediaType.GIF, -1, -1}, {"loop_4_length_4s.gif", CLASSPATH, MediaType.GIF, 4, 4}, {"loop_19_length_19s.gif", CLASSPATH, MediaType.GIF, 19, 19}, {"native_screenshot.jpg", CLASSPATH, MediaType.JPEG, 0, 0}, {"static.gif", CLASSPATH, MediaType.GIF, 1, 0}};
    }
